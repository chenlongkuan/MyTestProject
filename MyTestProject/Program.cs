...
namespace MyTestProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(GpsFenceContains(fencePoints,new GpsPoint(){ Lng= 106.530739M, Lat = 29.593959M }));
            while (true)
            {
                testFence(fencePoints);
            }
           
        }

        private static void testFence(GpsPoint[] fencePoints)
        {
        ...
        public static string GpsFenceContains(GpsPoint[] poly, GpsPoint p)
        {
